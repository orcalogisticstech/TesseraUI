...
type RunDetailsSectionId = "requestContext" | "solutionMetrics" | "batches" | "unselectedTasks";

type RunDetailsSectionState = Record<RunDetailsSectionId, boolean>;

const defaultCollapsedSections: RunDetailsSectionState = {
  requestContext: false,
  solutionMetrics: false,
  batches: true,
  unselectedTasks: true
};
...
function SectionHeader({
  ...
  return (
    <h2>
      ...
      >
        <span className="font-display text-lg uppercase tracking-[-0.01em]">{title}</span>
        <span className="shrink-0 text-xs uppercase tracking-[0.08em]" style={{ color: "var(--tessera-text-secondary)" }}>
...
export function RunDetailsView({ runTab }: RunDetailsViewProps) {
  ...
  const [collapsedSections, setCollapsedSections] = useState<RunDetailsSectionState>(defaultCollapsedSections);
  ...
  const toggleSection = (sectionId: RunDetailsSectionId) => {
  ...
  return (
    <div className="mx-auto w-full max-w-[1120px] space-y-4">
      ...
      <section className="app-card p-4 md:p-6">
        ...
        {!collapsedSections.requestContext ? (
          <>
      ...
      <section className="app-card p-4 md:p-6">
        <SectionHeader title="Solution Metrics" collapsed={collapsedSections.solutionMetrics} onToggle={() => toggleSection("solutionMetrics")} />
        {!collapsedSections.solutionMetrics ? (
      ...
      <section className="app-card p-4 md:p-6">
        <SectionHeader title="Batches" collapsed={collapsedSections.batches} onToggle={() => toggleSection("batches")} />
      ...
      <section className="app-card p-4 md:p-6">
        <SectionHeader title="Unselected Tasks" collapsed={collapsedSections.unselectedTasks} onToggle={() => toggleSection("unselectedTasks")} />
        {!collapsedSections.unselectedTasks ? (
          <>
